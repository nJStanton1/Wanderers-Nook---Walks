...
title: Hollingwood Lake - Close and Far
featured: false
...
overview:
  ...
  terrain: Trail
route:
  overview: This route starts and at Littleborough Train Station. Here there are
    cafés, shops and amenities.
  sections:
    - content: >-
        Immediately from the station, you head down a short stretch of the
        canal. Cross an old lock, with cobbled pavement and down a very green
        footpath. A flat, gentle intro to the route that lets you warm up.
      ...
      title: Heading Out
    - content: >-
        From here you will head down a small stream. This stream is one of an
        uncountable group that feed into the huge lake. Crossing the bridge
        further down, you'll dip back into the woodland.  Keep an eye out for
        water fowl in this area!
      ...
      title: Hollingwood Lake
      image: img20240620115858.jpg
    - content: >-
        Heading further down the track, you will see the M62 viaduct ahead. A
        brutalist outpost juxtaposed by its settings. The track you head up will
        be a shallow climb.
      ...
      title: Schofield Hall Hill
      image: img20240620121135.jpg
    - content: >-
        At the top of the hill, head over the bridge to cross the M62. I find
        this moment is surreal, to be deep in the countryside, with an
        ultimately thin streak of civilization cutting through it like a scar.
    ...
    - content: >-
        After the track, you follow a road a short way and at the junction find
        a bridleway. This heads up the second hill of the journey. Though steep,
        it's short and manageable.


        Follow this under the pylons and head down towards the road.
      title: The Bridleway
    - content: Now, you'll turn back down the road, and you're heading back into the
        town. It's a short section, and you'll be heading to the canal soon.
      title: Heading Back
    - content: >-
        Descending a lane past some large houses, you'll come out on the canal.
        From here, you follow the canal into Littleborough, where you started.
