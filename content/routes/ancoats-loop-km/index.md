...
route:
  overview: Starting near Piccadilly, you join the Rochdale Canal, then cross over
    ...
    no preparation. It may make a nice saunter for lunch, should you work in a
    nearby office.
  sections:
    - title: Finding the Rochdale Canal
      content: You can find the canal by heading up Ducie Street, and towards the
        GoOutdoors. There are blue signposts pointing you in the right direction
        as well.
      image: img20240806122727.jpg
    - title: Rochdale Canal
      content: >-
        Head along the canal, enjoying the peace and quiet. The canal here I
        found to be surprisingly clean and pleasant. The area is well-developed,
        having been improved recently.


        In particular, the Royal Mill overlooks a lock on the left, with some public seating.
      image: img20240806124057.jpg
    - title: New Islington Marina
      content: You will turn right at the Marina. Crossing the "Cast No Shadow Bridge"
        (*look down*), you will go down the Marina. There's half a dozen cafés
        and bars here, and it is a very lively area. You can also cross over,
        where you'll find a small park to wander round. Continue down to Ashton
        Canal and turn right.
      image: img20240806124720.jpg
    - title: Ashton Canal
      content: Heading back towards the centre now. It passes one of the oldest locks
        on the canal, which is guarded by the Lock Keeper's Cottage. This
        building is currently being restored. And it is a beautiful spot for
        artists and photographers. Heading further along, you cross a canal
        aqueduct.
      image: img20240806125415.jpg
    - content: You'll end up on the same road you walked down. Head down the road to
        Piccadilly and you are there.
      title: Returning to Piccadilly
...
title: Ancoats Marina and Locks
overview:
  length: 2.1
  elevation: 0
  osMapLink: https://explore.osmaps.com/route/22696518/wn-ancoats-loop?lat=53.481655&lon=-2.229534&zoom=15.7954&style=Standard&type=2d
